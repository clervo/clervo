...
test('production cloud contract is bounded, recoverable, and leaves the protected gateway outside scope', async () => {
  ...
  assert.deepEqual(policy.observedBootstrap, {
    observedAt: '2026-08-03T15:14:13.781Z',
    ...
    sandboxCandidateCloudBuildId: 'db68d6ff-8abc-4aef-9abf-de4f2f068689',
    sandboxCandidateReleaseCommit: '92dc26cdbedfadc614d4246a9c6b30cc0e72f5f1',
    sandboxCandidateImageDigest: 'sha256:e5514004a5b6c1235ebfa9f9344ce0b9f64d6ab6de4da8c8850e8ffeb6d88248',
    ...
    sandboxCandidateDeployed: true,
    sandboxCandidateRevision: 'clervo-api-production-00007-jal',
    sandboxCandidateTrafficPercent: 0,
    sandboxLiveSmokePassed: true,
    sandboxReplayPassed: true,
    sandboxUsefulOutput: 'sandbox-api-live',
    sandboxMeteredChargeAtomic: '0',
    sandboxRuntimeCleanupPassed: true,
    trafficChanged: true,
