...
COPY --chown=65532:65532 packages/catalog/ai-model-catalog.v1.json packages/catalog/ai-launch-pricing.v1.json packages/catalog/ai-credit-backed-pricing.v1.json packages/catalog/ai-speech-pricing.v1.json packages/catalog/ai-free-tier-pricing.v1.json packages/catalog/ai-edge-free-pricing.v1.json packages/catalog/prediction-product-pricing.v1.json ./packages/catalog/
COPY --chown=65532:65532 infra/prediction/source-routes.v1.json ./infra/prediction/
COPY --chown=65532:65532 apps/api/src/ai-artifact-runtime.mjs apps/api/src/ai-dynamic-production-runtime.mjs apps/api/src/ai-production-runtime.mjs apps/api/src/ai-public-pricing.mjs apps/api/src/crypto-production-runtime.mjs apps/api/src/monitoring-exporter.mjs apps/api/src/prediction-market-store.mjs apps/api/src/prediction-production-runtime.mjs apps/api/src/prediction-public-policy.mjs apps/api/src/rpc-production-runtime.mjs apps/api/src/sandbox-operation-store.mjs apps/api/src/sandbox-private-gateway.mjs apps/api/src/search-server.mjs apps/api/src/search-state-store.mjs apps/api/src/staging-search-main.mjs apps/api/src/traffic-control.mjs apps/api/src/x402-operation-store.mjs apps/api/src/x402-paid-ai.mjs apps/api/src/x402-paid-crypto.mjs apps/api/src/x402-paid-operation.mjs apps/api/src/x402-paid-prediction.mjs apps/api/src/x402-paid-rpc.mjs apps/api/src/x402-paid-sandbox.mjs apps/api/src/x402-paid-search.mjs apps/api/src/x402-resource.mjs ./apps/api/src/
