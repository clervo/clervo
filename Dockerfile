...
COPY --chown=65532:65532 apps/api/src/monitoring-exporter.mjs apps/api/src/search-server.mjs apps/api/src/search-state-store.mjs apps/api/src/staging-search-main.mjs apps/api/src/traffic-control.mjs ./apps/api/src/
