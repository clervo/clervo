...
COPY --chown=65532:65532 apps/api/src/ai-production-runtime.mjs apps/api/src/ai-public-pricing.mjs apps/api/src/monitoring-exporter.mjs apps/api/src/sandbox-operation-store.mjs apps/api/src/sandbox-private-gateway.mjs apps/api/src/search-server.mjs apps/api/src/search-state-store.mjs apps/api/src/staging-search-main.mjs apps/api/src/traffic-control.mjs apps/api/src/x402-operation-store.mjs apps/api/src/x402-paid-ai.mjs apps/api/src/x402-paid-operation.mjs apps/api/src/x402-paid-sandbox.mjs apps/api/src/x402-paid-search.mjs apps/api/src/x402-resource.mjs ./apps/api/src/
