...
function StageContent({ index, selectedEnv }: { index: number; selectedEnv: string }) {
  ...
  const [family, setFamily] = useState<(typeof FAMILY_NAMES)[number]>(FAMILY_NAMES[0]);
