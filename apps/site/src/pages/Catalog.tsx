                    ...
                    <article className="s4-operation-card" key={route.routeId} data-lifecycle={route.lifecycleState}>
                      ...
                      <div className="s4-op-description">
                        ...
                        <div className="s4-op-meta">
                          <div><small>Maximum charge</small><strong>{route.observedPrice == null ? 'request a quote' : formatUsdc(route.observedPrice.amountAtomic, route.observedPrice.decimals)}</strong></div>
