...
const destinations = [
  ...
  { title: 'Products', path: '/product', terms: 'catalog search ai sandbox prediction crypto availability' },
  ...
  { title: 'Capability catalog', path: '/docs/catalog', terms: 'catalog products availability routes machine discovery' },
  { title: 'Pricing', path: '/pricing', terms: 'price quote maximum charge usdc x402' },
  ...
  { title: 'Changelog', path: '/changelog', terms: 'changes packages payment routes models' },
