...
const contractTests = [
  ...
  // Crypto production readiness is qualification-time-bound. Keep the runtime
  // suite in acceptance so source-route evidence and runtime expiry cannot drift.
  'tests/contract/crypto-production-runtime.test.mjs',
