...
const capabilities = [
  ...
  {
    capabilityId: 'search.web', publicAssets: priced('search-supply-pricing.v1.json', ({ publicSellable }) => publicSellable === true), lifecycle: 'production', routeState: 'qualified_commercial_open_primary_with_health_fallback', primaryServices: ['supply.wikimedia_open_data'], fallbackServices: ['supply.crossref_open_metadata'], pricingCatalogs: [ref('search-supply-pricing.v1.json')], quality: 'good', termsStatus: 'approved', quotaRunway: 'Open no-fee APIs are selected under explicit license/metadata permissions with hard per-process call ceilings, polite identity, maxlag, and no paid overage. Brave and Serper remain technical-only because current resale terms are not approved.', healthMethod: ['https://foundation.wikimedia.org/wiki/Policy:Terms_of_Use', 'https://www.mediawiki.org/wiki/API:Etiquette', 'https://www.crossref.org/documentation/retrieve-metadata/rest-api/rest-api-etiquette/', 'tests/contract/search-supply-routing.test.mjs', 'tests/contract/b10-search-sandbox.test.mjs'], secretLocations: ['none:open_data_route'], replacementPlan: 'Keep the open licensed/metadata route bounded and attribution-preserving. Re-evaluate a paid general-web supplier only after written commercial permission and owner approval.'
  },
  {
