...
const fixedRoutes = [
  ...
  ['/proof', 'Payment and replay proof', 'Inspect Clervo proof classes, owner-funded settlement evidence, replay guarantees and the boundary between verified, refused, unresolved and unproven claims.'],
